...
// This is a function that calls BIO_read in a loop until there is no data to be read.
...
int main(int argc, char *argv[]) {
    ...
    // Log in to the Gmail IMAP server
    ...
    char total_login[MAX_BUFFER_SIZE];
    ...
    char total_select[MAX_BUFFER_SIZE];
    ...
    char total_fetch[102400];  // Using a larger array because a very long email would crash the program
